        ...
        <div>
          ...
          <div className="mt-4 text-center space-x-2">
            <button
              ...
              className="px-12 py-2 text-white bg-red-500 border border-red-500 hover:bg-transparent hover:text-red-500  duration-300"
            >
              {loading ? "Loading.." : "Yes"}
            </button>
            <Link href={"/products"} replace>
              <button className="px-12 py-2 text-white bg-black border-black hover:bg-transparent hover: hover:text-black  border duration-300">
                No
              </button>
            </Link>
          </div>
