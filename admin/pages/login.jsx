  ...
  return (
    <div className='h-screen bg-black flex items-center justify-center p-3'>
        <form onSubmit={handleSubmit} className='max-w-[400px] bg-white w-full p-4 flex flex-col gap-8 rounded-sm'>
            <h1 className='text-5xl text-indigo-500 capitalize'>Login</h1>
            ...
            <button disabled={!email || !password || loading} className='bg-indigo-500 outline-none text-white py-3 rounded-sm disabled:bg-gray-400'>{loading ? 'Loading...':"Login"}</button>
